...
A professional, interactive Power BI dashboard designed to analyze patient health data and uncover insights related to heart disease survival, risk factors, and demographics.

This dashboard highlights critical metrics such as survival rates, average survival age, serum creatinine, ejection fraction, and patterns related to lifestyle choices (smoking, diabetes, anaemia, high blood pressure) across different age groups.

📝 Short Description / Purpose
The Heart Disease Analysis Dashboard transforms raw medical records from Excel into an easy-to-read, visually compelling report. It empowers doctors, healthcare analysts, and medical researchers to:

Detect survival trends across age groups.
Examine the role of lifestyle and medical comorbidities.
Improve decision-making for preventive care and patient management.
⚙️ Tech Stack
...
Understand comorbidity effects on survival.
Plan targeted awareness and prevention campaigns.
...
Open Heart_Disease_Analysis.pbix in Power BI Desktop.
